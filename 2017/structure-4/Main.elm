...
model =
    ...
    , projects =
        [ Project.Model "Conquer Persia" False
        , Project.Model "Conquer Aegyptus" False
        ]
    }
...
update msg model =
    case msg of
        ...
        ProjectMsg name projectMsg ->
            let
                projects =
                    List.map
                        (\project ->
                            if project.name == name then
                                Project.update projectMsg project
                            else
                                project
                        )
                        model.projects
...
viewProjects : List Project.Model -> Html Msg
viewProjects projects =
    div []
        ((List.map
            (\project ->
                (Html.map (ProjectMsg project.name) (Project.view project))
            )
         )
            projects
        )
